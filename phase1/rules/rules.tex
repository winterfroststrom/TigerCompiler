...
\atag{stat}						&	break ;		\\
\atag{stat}						&	return \atag{expr} ;		\\
\atag{expr}					&	\atag{expr} \atag{orop} \atag{orexpr}		\\
\atag{expr}					&	\atag{orexpr}		\\
\atag{orop} 					&	|		\\
\atag{orexpr} 					&	\atag{orexpr} \atag{andop} \atag{andexpr}		\\
\atag{orexpr} 					&	\atag{andexpr}		\\
\atag{andop}					&	\&		\\
\atag{andexpr} 					&	\atag{andexpr} \atag{compop} \atag{compare}		\\
...
\atag{compop}					&	$>=$		\\
\atag{compop}					&	$<=$		\\
\atag{compare}					&	\atag{compare} \atag{addop} \atag{term}		\\
\atag{compare}					&	\atag{addexpr}		\\
\atag{addop}					&	+		\\
\atag{addop}					&	-		\\
\atag{term}					&	\atag{term} \atag{mulop} \atag{factor}		\\
